(function () {
  ...
  var I18N = {
    zh: {
      ...
      features_desc: "六大核心模块覆盖短剧制作全流程，从故事框架到 API 接入，一站式完成。",
      feat_1_title: "竖屏互动播放",
      ...
      footer_wechat: "商务微信",
      footer_company: "公司",
      footer_company_name: "星造娱乐传媒（深圳）有限公司",
      footer_share: "分享",
      share_weibo: "微博",
      share_wechat: "微信",
      share_xhs: "小红书",
    ...
    en: {
      ...
      features_desc: "Six core modules cover the full production pipeline, from story framework to API integration.",
